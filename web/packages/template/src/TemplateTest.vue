...
<script>
  ...
  import BodyDoc from '../../body-doc/index';
  import HeaderDoc from '../../header-doc/index';
  import HeaderDocItem from '../../header-doc-item/index';
  import Layout from '../../layout/index';
  import LeftDocNav from '../../left-doc-nav/index';
  ...
  export default {
    ...
    name: `${Conf.prefixCls}-template-test`,

    componentName: `${Conf.prefixNameCls}TemplateTest`,
